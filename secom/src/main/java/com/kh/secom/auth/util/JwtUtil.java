...
public class JwtUtil {
	...
	// javax.crypto.SecretKey 타입의 필드로 JWT서명에 사용할 수 있음
	private SecretKey key;
	
	private long ACCECC_TOKEN_EXPIRED = 3600000L * 24; // 1일
	...
	public String getAccessToken(String username) {
		return Jwts.builder()
				   ...
				   .expiration(new Date(System.currentTimeMillis() + 3600000L * 24 + ACCECC_TOKEN_EXPIRED)) // 만료일
